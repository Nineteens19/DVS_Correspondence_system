...
description: >-
  ...
  ใช้เมื่อผู้ใช้ส่ง Business Rules / requirement / SRS Analysis มาให้เพื่อจัดทำตาราง Test Case
---
...
- อ้างอิงโครงสร้างจากไฟล์ตัวอย่าง `Phase1_memno_CREDR/.kiro/Example_Testcase/Mortortestcase.xlsx`

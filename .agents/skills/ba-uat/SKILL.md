...
description: >-
  ...
  ใช้เมื่อผู้ใช้ส่ง Test Case / ผลการทดสอบ / requirement มาให้เพื่อจัดทำเอกสาร UAT ทางการ
---
...
2. **Clarify ก่อนเสมอ:** หากข้อมูลไม่ครบ ให้ถามก่อน เช่น รายชื่อ Contact Person (Business Owner/Users และ IT), Test Environment (URL/ระบบ), ช่วงวันที่ทดสอบ, ผลการทดสอบจริง (Passed/Failed/Pending/Cancel), เอกสาร Test Case ที่อ้างอิง
...
> ดูสไตล์ UAT จริงได้จากไฟล์ตัวอย่าง `Phase1_memno_CREDR/.kiro/Example_Doc/UAT/F-BP-005-UAT-P2026-012-Phase1-V1.0.0.docx`

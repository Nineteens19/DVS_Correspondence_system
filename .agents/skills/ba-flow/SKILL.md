...
description: >-
  ...
  ใช้เมื่อต้องการออกแบบ workflow, flowchart, sequence diagram หรือ state machine ของเอกสาร
---
...
> ดูสไตล์ Flow จริงของผู้ใช้ได้จากไฟล์ตัวอย่างในโฟลเดอร์ `Phase1_memno_CREDR/.kiro/Example_DraftAnalyzeRequiment_kickoff/` ซึ่งมี Mermaid diagram หลายชนิดประกอบ

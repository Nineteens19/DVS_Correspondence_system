...
**Version:** 2.0.0 (ฉบับสมบูรณ์พร้อมภาพประกอบหน้าจอจริงจากระบบ UAT)  
**Prepared by:** Business Analyst (BA)  
**Created Date:** 26 สิงหาคม 2569  
...
ตารางแสดงรายการคำขอเลขที่เอกสารบันทึกภายในทั้งหมด โดยผู้ใช้ทั่วไปจะเห็นเฉพาะคำขอของตนเอง ส่วน Admin จะเห็นข้อมูลทุกฝ่าย
...
- **ปุ่ม Action:** ปุ่ม `+ ขอสร้างเลขเอกสารบันทึกภายใน` สำหรับเปิดฟอร์มสร้างคำขอใหม่
- **คอลัมน์ในตาราง:** เลขที่เอกสาร, วันที่ขอ, ชื่อเรื่อง, ประเภทเอกสาร, สายงาน/ฝ่าย/หน่วยงานย่อย, ผู้ขอ, ลิงค์ SharePoint, สถานะ, และปุ่มดูรายละเอียด (Action)

---

### 11.4 หน้าฟอร์มขอสร้างเลขเอกสารบันทึกภายใน (Create Internal Request Form)

ฟอร์มสำหรับกรอกข้อมูลคำขอสร้างเลขเอกสารบันทึกภายใน ประกอบด้วยการเลือกประเภทเอกสาร การเลือกหน่วยงานย่อย และการระบุลิงค์ SharePoint
...
- **โครงสร้างฟิลด์:**
  ...
  2. **ประเภทเอกสาร (DocTypeId) [Mandatory]:** Searchable Dropdown เลือกประเภทเอกสาร พร้อมปุ่ม "+ เพิ่มประเภทเอกสาร"
  3. **ลิงค์เอกสาร SharePoint (DocumentUrl) [Optional]:** กล่องข้อความกรอก URL พร้อมปุ่มทดสอบเปิดลิงค์
  4. **หมายเหตุ (Remark) [Optional]:** กล่องข้อความรายละเอียดเพิ่มเติม
  5. **หน่วยงานย่อย (ทีม) (UnitId) [Optional]:** Dropdown เลือกทีมในฝ่ายของผู้ขอ (Default = "ไม่ระบุ")
  6. **ผู้ขอ / ฝ่าย / สายงาน:** แสดงข้อมูลอัตโนมัติจาก AD และ Master Hierarchy (Read-only)

#### Searchable Dropdown เลือกประเภทเอกสาร
เมื่อผู้ใช้คลิกที่ช่องเลือกประเภทเอกสาร ระบบจะแสดงรายการประเภทเอกสารที่ Active พร้อมกล่องค้นหาแบบพิมพ์เพื่อกรองคำ

![Searchable Dropdown เลือกประเภทเอกสาร](images/05a_doctype_dropdown.png)

#### ตัวอย่างการกรอกข้อมูลและระบุ SharePoint URL
ผู้ใช้กรอกข้อมูลครบถ้วน พร้อมระบุลิงค์เอกสาร SharePoint ที่ขึ้นต้นด้วย `https://`

![ตัวอย่างการกรอกฟอร์มขอเลขบันทึกภายใน](images/05b_create_form_filled.png)

---

### 11.5 หน้าต่างเพิ่มประเภทเอกสารด่วน (Quick Add Modal)

เมื่อผู้ขอค้นหาประเภทเอกสารใน Dropdown แล้วไม่พบ และมีสิทธิ์ `idt_quickadd` สามารถเปิด Modal เพื่อเพิ่มประเภทเอกสารใหม่ได้ทันทีโดยไม่ต้องสลับหน้าจอ

![Quick Add Modal เพิ่มประเภทเอกสารด่วน](images/05c_quick_add_modal.png)

- **Trigger:** คลิกปุ่ม `+ เพิ่มประเภทเอกสาร` ภายใน Searchable Dropdown
- **Fields ใน Modal:**
  - `ชื่อประเภทเอกสาร (ภาษาไทย)*` [Mandatory] — ระบบ Prefill คำค้นหาที่พิมพ์ค้างไว้
  - `ชื่อภาษาอังกฤษ` [Optional]
  - `คำอธิบาย` [Optional]
- **พฤติกรรม:** เมื่อกด "บันทึก" ระบบจะสร้างรหัสใหม่แบบอัตโนมัติ (`DTxxxx`) บันทึก `Source=QUICKADD`, `ReviewStatus=PENDING` ปิด Modal และเลือกรายการที่สร้างใหม่ในฟอร์มทันที โดยที่ข้อมูลอื่นที่กรอกไว้ในฟอร์มไม่สูญหาย

---

### 11.6 หน้ารายละเอียดคำขอเลขที่เอกสารภายใน (Internal Request Detail Screen)

หน้าจอแสดงข้อมูลคำขอที่ออกเลขสำเร็จแล้ว แสดงสถานะปัจจุบัน ลิงค์เอกสาร SharePoint และปุ่มสำหรับปิดเลขเอกสาร

![หน้ารายละเอียดคำขอเลขที่เอกสารภายใน](images/04_internal_request_detail.png)

- **URL:** `/EDR/InternalRequest/Detail/{id}`
- **ข้อมูลที่แสดง:**
  - เลขที่เอกสารบันทึกภายใน (Document No.)
  - สถานะคำขอ (Status Badge: สร้างแล้ว / ใช้งาน / ปิดแล้ว / ยกเลิก)
  - ชื่อเรื่อง, วันที่สร้าง, ผู้ขอ, ฝ่าย, สายงาน, หน่วยงานย่อย
  - ประเภทเอกสาร (รหัส - ชื่อ)
  - ลิงค์เอกสาร SharePoint (แสดงเป็น Hyperlink พร้อมไอคอนเปิดในแท็บใหม่ และปุ่มแก้ไขตามสิทธิ์)
  - หมายเหตุ และเหตุผลการปิดเลข (ถ้ามี)
- **ปุ่ม Action:**
  - `ปิดเลขเอกสาร`: เปิด Modal เพื่อระบุเหตุผลและยืนยันการปิดเลข
  - `แก้ไขลิงค์`: เปิด Modal หรือกล่องแก้ไข URL
  - `ย้อนกลับ`: กลับไปยังหน้ารายการ

#### Modal ปิดเลขเอกสาร (Close Document Modal)
เมื่อผู้ขอหรือ Admin ต้องการปิดเลขเอกสาร จะต้องระบุเหตุผลการปิดทุกครั้ง
